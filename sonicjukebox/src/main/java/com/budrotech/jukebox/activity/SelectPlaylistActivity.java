...
import com.budrotech.jukebox.service.OfflineException;
import com.budrotech.jukebox.service.ServerTooOldException;
import com.budrotech.jukebox.util.BackgroundTask;
import com.budrotech.jukebox.util.CacheCleaner;
import com.budrotech.jukebox.util.Constants;
import com.budrotech.jukebox.util.LoadingTask;
...
public class SelectPlaylistActivity extends JukeboxTabActivity implements AdapterView.OnItemClickListener
{
	...
	public boolean onContextItemSelected(MenuItem menuItem)
	{
		...
		switch (menuItem.getItemId())
		{
			...
			case R.id.playlist_menu_play_now:
				...
				Util.startActivityForResultWithoutTransition(SelectPlaylistActivity.this, intent);
				break;
