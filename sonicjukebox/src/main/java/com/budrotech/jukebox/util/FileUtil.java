 ...
 */
package com.budrotech.jukebox.util;
...
public class FileUtil
{
	...
	{
		File playlistDir = new File(getSonicJukeboxDirectory(), "playlists");
	...
	public static Bitmap getAvatarBitmap(String username, int size, boolean highQuality)
	{
		...
		JukeboxTabActivity jukeboxTabActivity = JukeboxTabActivity.getInstance();
		Bitmap bitmap = null;
		ImageLoader imageLoader = null;

		if (jukeboxTabActivity != null)
		{
			imageLoader = jukeboxTabActivity.getImageLoader();
	...
	{
		File albumArtDir = new File(getSonicJukeboxDirectory(), "artwork");
	...
	{
		File dir = new File(getSonicJukeboxDirectory(), name);
	...
	public static File getSonicJukeboxDirectory()
	{
		return new File(Environment.getExternalStorageDirectory(), "Android/data/com.budrotech.sonicjukebox");
	}
